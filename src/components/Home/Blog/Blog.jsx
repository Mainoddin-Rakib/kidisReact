...
import blogShape1 from './../../../assets/images/animation-shape/blogshape1.png'
import blogShape2 from './../../../assets/images/animation-shape/blogshape2.png'
import blogShape3 from './../../../assets/images/animation-shape/blogshape3.png'

const Blog = ({ blogs }) => {
    return (
        <>
            <section className="blog">
            <div className="blog-shape-slider">
            <img className="blog-shape blog-shape1" src={blogShape1} alt=""/>
            <img className="blog-shape blog-shape2" src={blogShape2} alt=""/>
            <img className="blog-shape blog-shape3" src={blogShape3} alt=""/>
        </div>
                                    ...
                                    <div className="blog-cart">
                                        <div className="blog-img-wrapper">
                                            ...
                                            <div className="blog-date">
                                                ...
                                                <span>{blog?.blogmonth}</span>
                                            </div>
                                        </div>
                                        <div className="blog-desc">
                                            <p className="blog-sub-title">{blog?.subTitle}</p>
                                            <div className="blog-title">
                                                <h4>{blog?.title}</h4>
                                                <span href="">{blog?.dsc}</span>
                                            </div>
                                            <div className="blog-admin">
                                                <div className="admin-img">
                                                    <img src={blog?.adminImg} alt="" />
                                                    <div className="admin-intro">
                                                        <p className="admin-name">{blog?.adminName}</p>
